@extends('layouts.sales_management_select_btn_id_layout')

<!--コンテンツの表　タイトル-->
<?php $tabletitles=array("ＮＯ","商品番号","チケット名","select_btn_id","販売期間","券種","価格","キャンセル料","売上枚数","キャンセル料なし","キャンセル料あり","合計金額","　　　　"); ?>
...
@section('content')
            ...
            <table class = "tableitem">
                @csrf
                    ...
                    <tr>
                        ...
                        <td class="itemtd">{{ $index['select_btn_id'] }}</td>
    ...
    <div class="listpage">
        <form action="sales_management_list_select_btn_id" method="post" name="salesmanagementPageform" enctype= "multipart/form-data">
            @csrf
            @if($table['lastpage']>1)
